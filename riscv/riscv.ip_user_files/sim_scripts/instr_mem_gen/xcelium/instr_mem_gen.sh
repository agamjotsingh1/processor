...
#
# Script generated by Vivado on Wed Nov 12 16:36:37 IST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : instr_mem_gen.sh
...
#
# Usage        : instr_mem_gen.sh
#                instr_mem_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instr_mem_gen.sh [-reset_run]
#                instr_mem_gen.sh [-reset_log]
#                instr_mem_gen.sh [-help]
#
...
#                script (type 'instr_mem_gen.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname blk_mem_gen_v8_4_11 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm blk_mem_gen_v8_4_11 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "instr_mem_gen.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instr_mem_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.instr_mem_gen xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.instr_mem_gen -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log instr_mem_gen_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./instr_mem_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: instr_mem_gen.sh [-help]\n\
Usage: instr_mem_gen.sh [-step]\n\
Usage: instr_mem_gen.sh [-lib_map_path]\n\
Usage: instr_mem_gen.sh [-reset_run]\n\
Usage: instr_mem_gen.sh [-reset_log]\n\
Usage: instr_mem_gen.sh [-keep_index]\n\
Usage: instr_mem_gen.sh [-noclean_files]\n\n\
