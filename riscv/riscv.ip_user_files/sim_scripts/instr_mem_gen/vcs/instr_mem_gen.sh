...
design_libs=(xilinx_vip xpm blk_mem_gen_v8_4_11 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.instr_mem_gen xil_defaultlib.glbl -o instr_mem_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./instr_mem_gen_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/agamubuntu/Github/processor/riscv/riscv.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key instr_mem_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc instr_mem_gen_simv.daidir vcs_lib c.obj)
