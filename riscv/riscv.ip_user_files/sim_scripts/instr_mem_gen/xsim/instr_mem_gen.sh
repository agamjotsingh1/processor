...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot instr_mem_gen xil_defaultlib.instr_mem_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim instr_mem_gen -key {Behavioral:sim_1:Functional:instr_mem_gen} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb instr_mem_gen.wdb xsim.dir libdpi.so)
