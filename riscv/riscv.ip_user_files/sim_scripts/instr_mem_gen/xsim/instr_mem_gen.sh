...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot instr_mem_gen xil_defaultlib.instr_mem_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim instr_mem_gen -key {Behavioral:sim_1:Functional:instr_mem_gen} -tclbatch cmd.tcl -log simulate.log
}
