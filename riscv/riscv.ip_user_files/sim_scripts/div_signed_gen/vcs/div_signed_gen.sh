...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.div_signed_gen xil_defaultlib.glbl -o div_signed_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./div_signed_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key div_signed_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc div_signed_gen_simv.daidir vcs_lib c.obj)
