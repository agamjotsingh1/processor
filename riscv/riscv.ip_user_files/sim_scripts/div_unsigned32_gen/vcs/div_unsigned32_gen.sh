...
design_libs=(xilinx_vip xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_23 floating_point_v7_0_25 div_gen_v5_1_24 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.div_unsigned32_gen xil_defaultlib.glbl -o div_unsigned32_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./div_unsigned32_gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key div_unsigned32_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc div_unsigned32_gen_simv.daidir vcs_lib c.obj)
