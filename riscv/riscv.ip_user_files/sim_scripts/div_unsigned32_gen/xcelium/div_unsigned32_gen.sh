...
#
# Script generated by Vivado on Wed Nov 12 19:29:01 IST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : div_unsigned32_gen.sh
...
#
# Usage        : div_unsigned32_gen.sh
#                div_unsigned32_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_unsigned32_gen.sh [-reset_run]
#                div_unsigned32_gen.sh [-reset_log]
#                div_unsigned32_gen.sh [-help]
#
...
#                script (type 'div_unsigned32_gen.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname xbip_pipe_v3_0_10 -libname xbip_dsp48_wrapper_v3_0_7 -libname mult_gen_v12_0_23 -libname floating_point_v7_0_25 -libname div_gen_v5_1_24 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_23 floating_point_v7_0_25 div_gen_v5_1_24 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "div_unsigned32_gen.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_unsigned32_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/agamubuntu/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.div_unsigned32_gen xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.div_unsigned32_gen -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/agamubuntu/Github/processor/riscv/riscv.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log div_unsigned32_gen_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_unsigned32_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_unsigned32_gen.sh [-help]\n\
Usage: div_unsigned32_gen.sh [-step]\n\
Usage: div_unsigned32_gen.sh [-lib_map_path]\n\
Usage: div_unsigned32_gen.sh [-reset_run]\n\
Usage: div_unsigned32_gen.sh [-reset_log]\n\
Usage: div_unsigned32_gen.sh [-keep_index]\n\
Usage: div_unsigned32_gen.sh [-noclean_files]\n\n\
