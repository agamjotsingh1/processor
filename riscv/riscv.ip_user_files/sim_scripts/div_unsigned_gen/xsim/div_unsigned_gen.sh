...
export RDI_DATADIR="/home/agamubuntu/Xilinx/2025.1/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_23 -L floating_point_v7_0_25 -L div_gen_v5_1_24 -L secureip -L xpm --snapshot div_unsigned_gen xil_defaultlib.div_unsigned_gen -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim div_unsigned_gen -key {Behavioral:sim_1:Functional:div_unsigned_gen} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/agamubuntu/Xilinx/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb div_unsigned_gen.wdb xsim.dir libdpi.so)
