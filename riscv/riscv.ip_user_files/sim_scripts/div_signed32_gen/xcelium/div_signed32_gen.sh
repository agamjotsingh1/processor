...
#
# Script generated by Vivado on Wed Nov 12 19:28:31 IST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : div_signed32_gen.sh
...
#
# Usage        : div_signed32_gen.sh
#                div_signed32_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_signed32_gen.sh [-reset_run]
#                div_signed32_gen.sh [-reset_log]
#                div_signed32_gen.sh [-help]
#
...
#                script (type 'div_signed32_gen.sh -help' for more information).
#
...
# script info
echo -e "div_signed32_gen.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_signed32_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.div_signed32_gen xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.div_signed32_gen -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log div_signed32_gen_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_signed32_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_signed32_gen.sh [-help]\n\
Usage: div_signed32_gen.sh [-step]\n\
Usage: div_signed32_gen.sh [-lib_map_path]\n\
Usage: div_signed32_gen.sh [-reset_run]\n\
Usage: div_signed32_gen.sh [-reset_log]\n\
Usage: div_signed32_gen.sh [-keep_index]\n\
Usage: div_signed32_gen.sh [-noclean_files]\n\n\
